...
show_help() {
  ...
  echo "   --sdl-mobile-api         - path to SDL MOBILE API. Not used if pathToSDLSource is defined"
  echo "   --sdl-hmi-api            - path to SDL HMI API. Not used if pathToSDLSource is defined"
