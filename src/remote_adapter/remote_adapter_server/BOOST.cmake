...
if (NOT ${Boost_FOUND})
  ...
  if(NOT QNXNTO)
    ...
    if(${LINUX})
      ...
      set(BOOTSTRAP
          ./bootstrap.sh --with-libraries=system,filesystem --prefix=${BOOST_INSTALL})
      ...
      set(BOOTSTRAP
          env CC=\"\" ./bootstrap.sh --with-toolset=gcc --with-libraries=system,filesystem --prefix=${BOOST_INSTALL})

      string(STRIP "$ENV{CXXFLAGS} -fpic" LOL)

      set(BOOST_BUILD_COMMAND
          ./b2 toolset=gcc-agl cxxflags=${LOL})
    endif()
    ...
    set(BOOST_BUILD_COMMAND ./b2 address-model=${ADDRESS_MODEL} cxxflags="-stdlib=libstdc++ -fpic" linkflags="-stdlib=libstdc++" target-os=qnxnto toolset=gcc-nto${CMAKE_SYSTEM_PROCESSOR} --prefix=${BOOST_INSTALL})
