...
if (NOT ${Boost_FOUND})
  ...
  if(NOT QNXNTO)
    ...
    if(${LINUX})
      ...
      set(BOOTSTRAP
          env CC=\"\" ./bootstrap.sh --with-toolset=gcc --with-libraries=system --prefix=${BOOST_INSTALL})

      string(STRIP "$ENV{CXXFLAGS}" LOL)
    ...
    set(BOOST_BUILD_COMMAND ./b2 address-model=${ADDRESS_MODEL} cxxflags="-stdlib=libstdc++" linkflags="-stdlib=libstdc++" target-os=qnxnto toolset=gcc-nto${CMAKE_SYSTEM_PROCESSOR} --prefix=${BOOST_INSTALL})
